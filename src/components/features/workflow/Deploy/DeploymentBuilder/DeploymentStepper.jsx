...
const useStyles = makeStyles((theme) => ({
  ...
  stepContent: {
    width: '100%',
    borderLeft: (props) => (props.steps && props.activeStep === props.steps.length - 1
      ? '0px solid #FFFFFF'
      : '3px solid #CCC'),
  },
  stepLabel: {
...
const DeploymentStepper = (props) => {
  ...
  const getStepContent = (step) => `${steps[step].task_object.target}`;

  const getLabel = (step) => `${steps[step].task_object.action_name}`;
