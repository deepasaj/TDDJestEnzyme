        ...
        <div className="dropdown-menu" aria-labelledby="userDropDown">
          {
            hasWriteAccess && (
              <div>
                <a className="dropdown-item" href="/workflow/deploy/group/create" onClick={clickHandler}>
        ...
        <div className="dropdown-menu" aria-labelledby="userDropDown">
          {
            hasWriteAccess && (
              <div>
                <a className="dropdown-item" href="/workflow/validation" onClick={clickHandler}>
                  Request Device Report
                </a>
                <div className="dropdown-divider" />
              </div>
            )
