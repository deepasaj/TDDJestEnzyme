  ...
  return (
    ...
    >
      <DialogContent dividers className={classes.content}>
        <div className={classes.enterTitle}> Please title your job before proceeding. Click <b>Create and Continue</b> to create the job or <b> Cancel </b> to make changes. </div>
        <TextField
            id="standard-name"
            label="Title"
