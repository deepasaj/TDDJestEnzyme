...
function NavBar() {
  ...
  return (
    <nav className="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div>
        <img
          src={NODE_ENV === 'development' ? DevEnvImg : ProdEnvImg}
          width="30"
          height="30"
          className="d-inline-block align-top"
          alt="Da Gen"
        />
        <span className="navbar-text" style={{ paddingRight: '50px', paddingTop: '5px' }}>
          {NODE_ENV}
        </span>
      </div>
      <div className="dropdown">
        <button
          ...
          aria-expanded="false"
        >
          <img src={user.avatar} style={{ borderRadius: '5px', width: 32, height: 32 }} alt="avatar" />
